  ...
  const fetchAllAroundIndia = async () => {
    try {
      ...
      const response = await axios.get(
        `${API_BASE}/api/buyer/all-around-india`,
        {
          headers: {
  ...
  const openProductDetails = (productId) => {
    ...
    try {
      ...
      try {
        ...
        Alert.alert(
          "Navigation Error",
          "Could not open product detail screen. Check route names.",
        );
      }
    }
  };
    ...
    return (
      <View>
        <View style={styles.headerRow}>
          ...
          <TouchableOpacity
            onPress={() => navigation.navigate("ViewAllAroundIndia")}
          >
        ...
        <View style={styles.loadingContainer}>
          ...
          <Text allowFontScaling={false} style={styles.loadingText}>
            Fetching products across India...
          </Text>
        </View>
      </View>
    );
