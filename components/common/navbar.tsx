...
export default function HeaderDesign() {
  ...
  const applyFiltersToSuggestions = (products = [], activeFilters = null) => {
    ...
    const filtered = products.filter((product) => {
      ...
      const okPrice =
        price >= (f.priceMin ?? 0) &&
        price <= (f.priceMax ?? Number.MAX_SAFE_INTEGER);
          ...
          <View style={styles.suggestionsDropdown}>
            {loading ? (
              ...
              <View style={styles.noSuggestionsContainer}>
                ...
                <Text allowFontScaling={false} style={styles.noSuggestionsText}>
                  No products found
                </Text>
              </View>
            )}
        ...
        <View style={styles.addressModalOverlay}>
          ...
          >
            <View style={styles.addressModalHeader}>
              ...
              <Text allowFontScaling={false} style={styles.addressModalTitle}>
                Add New Address
              </Text>
              <Text></Text>
            </View>
            ...
            >
              <View style={styles.locationBoxModal}>
                <TouchableOpacity
                  style={[
                    styles.locationButtonModal,
                    locating && styles.locationButtonDisabledModal,
                  ]}
                ...
                >
                  ...
                  <Text
                    allowFontScaling={false}
                    style={styles.locationTextModal}
                  >
              ...
              <View style={styles.addressSection}>
                <Text
                  allowFontScaling={false}
                  style={styles.addressSectionTitle}
                >
                  Address Details *
                </Text>
                ...
                <TextInput
                  ...
                  onChangeText={(value) =>
                    handleAddressInputChange("houseNumber", value)
                  }
                  placeholderTextColor="#999"
                  editable={!addressLoading}
                  allowFontScaling={false}
                ...
                <TextInput
                  ...
                  onChangeText={(value) =>
                    handleAddressInputChange("locality", value)
                  }
                  placeholderTextColor="#999"
                  editable={!addressLoading}
                  allowFontScaling={false}
            ...
            <View style={styles.addressModalFooter}>
              ...
              >
                <Text
                  allowFontScaling={false}
                  style={styles.addressCancelButtonText}
                >
                  Cancel
                </Text>
              </TouchableOpacity>
              ...
              <TouchableOpacity
                style={[
                  ...
                  addressLoading && styles.addressSaveButtonDisabled,
                ]}
              ...
              >
                ...
                <Text
                  allowFontScaling={false}
                  style={styles.addressSaveButtonText}
                >
