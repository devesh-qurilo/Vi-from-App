...
const ProductCard = ({ item, onDelete, onStockUpdate, onEdit }) => {
    ...
    try {
      ...
      for (let ep of tryEndpoints) {
        try {
          ...
          if (
            resp &&
            (resp.data?.success || resp.status === 200 || resp.status === 204)
          ) {
            succeeded = true;
  ...
  return (
    ...
    >
      <Image
        source={{
          uri: (item.images && item.images[0]) || item.image || undefined,
        }}
      ...
      >
        ...
        <Text
          ...
          style={{ color: "#fff", fontSize: normalizeFont(11), width: "100%" }}
        >
          5.0
        </Text>
      </View>
      <View style={cardStyles.details}>
        ...
        <View style={cardStyles.row}>
          <Text allowFontScaling={false} style={cardStyles.label}>
            Category
          </Text>
          <Text allowFontScaling={false} style={cardStyles.colon}>
            :
          </Text>
          <Text
            allowFontScaling={false}
          ...
          >
            {updatingStock ? (
              <>
                ...
                <Text
                  allowFontScaling={false}
                  style={[cardStyles.stockText, cardStyles.updatingText]}
                >
                  Updating...
                </Text>
              </>
        ...
        >
          ...
          >
            ...
            >
              ...
              <Text allowFontScaling={false} style={cardStyles.menuItemText}>
                Edit
              </Text>
            </TouchableOpacity>
            ...
            >
              ...
              <Text
                allowFontScaling={false}
                style={[cardStyles.menuItemText, cardStyles.deleteText]}
              >
                Delete
              </Text>
            </TouchableOpacity>
        ...
        >
          ...
          >
            ...
            >
              ...
              <Text
                allowFontScaling={false}
                style={[cardStyles.stockOptionText, cardStyles.inStockText]}
              >
                In Stock
              </Text>
            </TouchableOpacity>
            ...
            >
              ...
              <Text
                allowFontScaling={false}
                style={[cardStyles.stockOptionText, cardStyles.outOfStockText]}
              >
                Out of Stock
              </Text>
            </TouchableOpacity>
...
function BufferFromBase64(b64) {
  try {
    ...
    const decoded =
      global && typeof global.atob === "function" ? global.atob(b64) : null;
...
const ProductFilter = ({
  ...
  useEffect(() => {
    const getAllCategory = async () => {
      try {
        ...
        const onlyNames =
          catRes.data?.categories?.map((item) => item.name).filter(Boolean) ||
          [];
  ...
  return (
    <View style={filterStyles.container}>
      <Text allowFontScaling={false} style={filterStyles.title}>
        My Products
      </Text>
      ...
      <View style={filterStyles.controls}>
        <TouchableOpacity
          ...
          activeOpacity={0.7}
        >
          <Text allowFontScaling={false} style={filterStyles.dropdownText}>
            {selectedCategory}
          </Text>
        ...
        >
          ...
          >
            <View style={filterStyles.modalHeader}>
              <Text allowFontScaling={false} style={filterStyles.modalTitle}>
                Filters
              </Text>
              <TouchableOpacity onPress={() => setIsFilterOpen(false)}>
                <Text allowFontScaling={false} style={filterStyles.closeButton}>
                  ✕
                </Text>
              </TouchableOpacity>
            </View>
  ...
  const filteredProducts = useMemo(() => {
    ...
    if (categoryToFilter) {
      filtered = filtered.filter((item) => {
        ...
        if (typeof cat === "object")
          return (cat.name || "") === categoryToFilter;
        return false;
      });
    }
    ...
    if (stockToFilter && stockToFilter !== "") {
      filtered = filtered.filter(
        (item) =>
          (item.status || "").toLowerCase() === stockToFilter.toLowerCase(),
      );
    }
