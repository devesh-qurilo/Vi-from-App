...
const styles = StyleSheet.create({
  ...
  count: { fontSize: normalizeFont(14), fontWeight: "bold", color: "#000" },
  small: { fontSize: normalizeFont(12), fontWeight: "normal", color: "#666" },
  growth: {
    fontSize: normalizeFont(12),
    fontWeight: "600",
    marginTop: moderateScale(4),
  },
  vs: { color: "#666", fontSize: normalizeFont(12), fontWeight: "normal" },
  ...
  noDataText: { fontSize: normalizeFont(12), color: "#999" },
  tooltip: {
    position: "absolute",
