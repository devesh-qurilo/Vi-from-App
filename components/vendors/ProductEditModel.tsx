  ...
  const fetchCategoriesAndVarieties = async () => {
    ...
    try {
      ...
      if (status === 401)
        ...
        Alert.alert(
          "Forbidden",
          "No permission to fetch categories/varieties.",
        );
  ...
  const handleUpdate = async () => {
    ...
    try {
      ...
      if (status === 401) Alert.alert("Session expired", "Please login again.");
        ...
        Alert.alert("Images too large", "Try smaller images or fewer images.");
      ...
      >
        <View style={styles.overlay}>
          ...
          >
            ...
            <Text style={styles.smallNote} allowFontScaling={false}>
            ...
            <View style={styles.row}>
                ...
                {isCategoryDropdownOpen && (
                  <View style={styles.dropdownBelowInput}>
                    {categoriesLoading ? (
                      ...
                      <View style={styles.dropdownOption}>
                        <Text
                          style={{ color: "#999", fontSize: bumpFont(10) }}
                          allowFontScaling={false}
                        >
              ...
              <View style={{ flex: 1, position: "relative" }}>
                ...
                >
                  ...
                  <Ionicons
                    name={isVarietyDropdownOpen ? "chevron-up" : "chevron-down"}
                    size={15}
                    color="#333"
                  />
                </TouchableOpacity>
              ...
              >
                {newImages.map((uri, idx) => (
                  <View key={`new-${idx}`} style={styles.imagePreviewContainer}>
                    ...
                    >
                      <Text
                        style={{ color: "#fff", fontSize: bumpFont(10) }}
                        allowFontScaling={false}
                      >
                        New
                      </Text>
            ...
            >
              ...
              <Text style={styles.imageUploadText} allowFontScaling={false}>
            ...
            <View style={styles.checkboxRow}>
              ...
              />
              <Text
                style={{ marginLeft: moderateScale(8), fontSize: bumpFont(12) }}
                allowFontScaling={false}
              >
                All India Delivery
              </Text>
