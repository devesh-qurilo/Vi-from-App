  ...
  const isPaymentSuccessful = (resData) => {
    ...
    try {
      ...
      if (
        ...
        s(resData.status).includes("paid")
      )
        return true;
      if (resData.paid === true) return true;
      if (resData.isPaid === true) return true;
      if (
        typeof resData.paymentStatus === "string" &&
        s(resData.paymentStatus).includes("paid")
      )
        return true;
  ...
  const handleProceed = async () => {
    ...
    try {
      ...
      if (!token) {
        Alert.alert(
          "❌ Not Authenticated",
          "Please login first to make a donation.",
        );
        setLoading(false);
        return;
      }
      ...
      if (resp?.data?.success) {
        ...
        Alert.alert(
          "❌ Donation Failed",
          resp?.data?.message || "Unable to create donation.",
        );
      }
    } catch (err) {
  ...
  const handleDownloadQR = async (qr) => {
    try {
      ...
      Alert.alert(
        "Error",
        e?.message ||
          "Failed to save QR code. Please take a screenshot instead.",
      );
    } finally {
      ...
      <View style={styles.container}>
        ...
        >
          ...
          <View style={styles.heroSection}>
            <Text allowFontScaling={false} style={styles.heroEmoji}>
              ❤️
            </Text>
            ...
            <Text allowFontScaling={false} style={styles.heroSubtitle}>
              Your donation helps us provide fresh, sustainable produce to
              communities in need
            </Text>
          </View>
          ...
          <View style={styles.impactSection}>
            ...
            <View style={styles.impactGrid}>
              <View style={styles.impactCard}>
                <Text allowFontScaling={false} style={styles.impactNumber}>
                  🌱
                </Text>
                <Text allowFontScaling={false} style={styles.impactLabel}>
                  Fresh Produce
                </Text>
              </View>
              <View style={styles.impactCard}>
          ...
          <View style={styles.whyDonateSection}>
            ...
            <View style={styles.reasonCard}>
              <Text allowFontScaling={false} style={styles.reasonIcon}>
                ✓
              </Text>
              <View style={styles.reasonContent}>
                <Text allowFontScaling={false} style={styles.reasonTitle}>
                  Direct Impact
                </Text>
                <Text allowFontScaling={false} style={styles.reasonDesc}>
                  Your donation directly supports local farmers and communities
                </Text>
              </View>
            </View>
            <View style={styles.reasonCard}>
              ...
              <View style={styles.reasonContent}>
                ...
                <Text allowFontScaling={false} style={styles.reasonDesc}>
                  100% transparent - see exactly where your donation goes
                </Text>
              </View>
            </View>
            <View style={styles.reasonCard}>
              ...
              <View style={styles.reasonContent}>
                ...
                <Text allowFontScaling={false} style={styles.reasonDesc}>
                  Help us build a sustainable agricultural ecosystem
                </Text>
              </View>
            </View>
          </View>
          ...
          <View style={styles.sheet}>
            ...
            <View style={styles.inputRow}>
              <View style={styles.rupeeBox}>
                <Text allowFontScaling={false} style={styles.rupeeText}>
                  ₹
                </Text>
              </View>
              <TextInput
            ...
            <Text allowFontScaling={false} style={styles.footerNote}>
              Secure UPI payment • Protected by encryption
            </Text>
          </View>
        </KeyboardAvoidingView>
      </View>
      ...
      >
        <View style={paymentModalStyles.overlay}>
          <View style={paymentModalStyles.panel}>
            ...
            >
              {/* Header */}
              <Text allowFontScaling={false} style={paymentModalStyles.title}>
                Complete Your Donation
              </Text>
              <Text
                allowFontScaling={false}
                style={paymentModalStyles.subtitle}
              >
              ...
              <View style={paymentModalStyles.manualSection}>
                <Text
                  allowFontScaling={false}
                  style={paymentModalStyles.sectionLabel}
                >
                ...
                <View style={paymentModalStyles.upiBox}>
                  <Text
                    allowFontScaling={false}
                    style={paymentModalStyles.upiText}
                  >
                    {paymentData?.upiId ?? "—"}
                  </Text>
                  <TouchableOpacity
                  ...
                  >
                    <Text
                      allowFontScaling={false}
                      style={paymentModalStyles.upiCopyText}
                    >
                      {copiedUPI ? "✓" : "Copy"}
                    </Text>
                  </TouchableOpacity>
              ...
              <View style={paymentModalStyles.actionButtonsContainer}>
                <TouchableOpacity
                  style={[
                    paymentModalStyles.actionButton,
                ...
                >
                  <Text
                    allowFontScaling={false}
                    style={paymentModalStyles.actionText}
                  >
                    ✓ I Have Paid
                  </Text>
                </TouchableOpacity>
                ...
                >
                  <Text
                    allowFontScaling={false}
                    style={[paymentModalStyles.actionText, { color: "#333" }]}
                  >
                    ← Back
                  </Text>
                </TouchableOpacity>
      ...
      <Modal visible={thankYouVisible} transparent animationType="fade">
        <View style={thankYouModalStyles.overlay}>
          <View style={thankYouModalStyles.card}>
            <Text
              allowFontScaling={false}
              style={thankYouModalStyles.largeEmoji}
            >
              💚
            </Text>
            ...
            <Text
              allowFontScaling={false}
              style={thankYouModalStyles.thanksSubtitle}
            >
              Your donation of ₹{paymentData?.amount || amount} will help us
              serve the community better
            </Text>
            <Text
              allowFontScaling={false}
              style={thankYouModalStyles.thanksBig}
            >
