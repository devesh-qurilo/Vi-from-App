    ...
    return apiOrders.map((order) => {
      const items = (order.items || []).map((item) => {
        ...
        return {
          ...
          vendorName:
            item.vendor?.name || productObj.vendor?.name || "Unknown Vendor",
          canReview:
        ...
        <View>
          {Array.isArray(order.items) && order.items.length > 0 ? (
            order.items.map((product, productIndex) => (
              <View
                key={
                  product.id ||
                  product.productId ||
                  `${order.id || order.orderId}_p_${productIndex}`
                }
              >
                {productIndex === 0 && (
                ...
                {productIndex < order.items.length - 1 && (
            ...
            <View style={{ paddingVertical: moderateScale(8) }}>
              <Text
                allowFontScaling={false}
                style={{ color: "#666", fontSize: normalizeFont(11) }}
              >
    ...
    <SafeAreaView style={styles.container}>
        ...
        <View style={styles.searchResultsContainer}>
          ...
          {filteredOrders.length > 0 && (
            <TouchableOpacity onPress={clearSearch}>
              <Text allowFontScaling={false} style={styles.clearAllText}>
                Clear
              </Text>
            </TouchableOpacity>
          )}
      ...
      {error ? (
        ...
        >
          <Text
            allowFontScaling={false}
            style={{ color: "#D32F2F", fontSize: normalizeFont(12) }}
          >
            {error}
          </Text>
        </View>
            ...
            >
              ...
              <TouchableOpacity
                style={[
                  ...
                  submitLoading && styles.modalSubmitButtonDisabled,
                ]}
