...
/* -------------------------
   ...
   ------------------------- */
const ImageModalViewer = ({ visible, images, initialIndex = 0, onClose }) => {
...
const ReviewCard = ({ r, onImagePress }) => {
  const avatar =
        ...
        <View style={styles.infoCard}>
          ...
          <View style={styles.nutritionRow}>
            <View style={styles.nutritionLeft}>
              <Text style={styles.nutritionHeading} allowFontScaling={false}>
                Nutritional Value
              </Text>
              ...
              {Array.isArray(nutrients) && nutrients.length > 0 ? (
                ...
                <View style={styles.nutritionList}>
                  <Text style={styles.nutritionItem} allowFontScaling={false}>
                    Calories : -
                  </Text>
                  <Text style={styles.nutritionItem} allowFontScaling={false}>
                    Carbs : -
          ...
          {Array.isArray(product.reviews) && product.reviews.length > 0 ? (
            <FlatList
              ...
              renderItem={({ item }) => (
                <ReviewCard r={item} onImagePress={handleReviewImagePress} />
              )}
