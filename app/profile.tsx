    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.profile}>
        ...
        <Text
          ...
          style={{ fontWeight: 700, fontSize: normalizeFont(14) }}
        >
          My Profile
        </Text>
        <Text></Text>
      ...
      >
        ...
        <View style={styles.menuSection}>
          <ProfileMenuItem
            ...
            title="My Address"
            subtitle={
              savedLocation ? "Edit your saved location" : "Add your location"
            }
              ...
              >
                ...
                <View style={styles.addressActionRow}>
                  ...
                  >
                    ...
                    <Text
                      allowFontScaling={false}
                      style={styles.addressActionText}
                    >
                      {gettingLocation
                        ? "Getting Location..."
