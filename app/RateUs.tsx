    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        <TouchableOpacity
          ...
          onPress={goBack}
        >
          <Image source={require("../assets/via-farm-img/icons/groupArrow.png")} style={{width:scale(32),height:scale(32)}} />
        </TouchableOpacity>
      ...
      >
        <View style={styles.card}>
          ...
          <TouchableOpacity style={styles.rateButton} onPress={openStore}>
            <Text  allowFontScaling={false} style={styles.rateButtonText}>Rate Now 5 ⭐</Text>
          </TouchableOpacity>
