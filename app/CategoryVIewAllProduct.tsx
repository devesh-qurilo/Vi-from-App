    ...
    <View style={[cardStyles.container, { width: cardWidth }]}>
      ...
      >
        ...
        <View style={cardStyles.cardContent}>
          ...
          >
            <Image
              style={{ width: scale(20), height: scale(28) }}
          ...
          <View style={cardStyles.priceContainer}>
            ...
            {item?.weightPerPiece ? (
              <Text allowFontScaling={false} style={cardStyles.productWeight}>
                /{item.weightPerPiece}
              </Text>
            ) : null}
          </View>
...
const CategoryViewAllProduct = () => {
  ...
  const fetchCategoryProducts = async () => {
    try {
      ...
      const response = await axios.get(`${API_BASE}/api/buyer/with-products`, {
        headers: {
      ...
      <View style={styles.header}>
        ...
        <View style={styles.searchWrapper}>
          ...
          <TouchableOpacity
            ...
            style={{ paddingHorizontal: moderateScale(2) }}
          >
            <Image
          ...
          <>
            {filteredProducts.length === 0 ? (
              ...
              >
                <Text
                  allowFontScaling={false}
                  style={{ color: "#444", fontSize: normalizeFont(14) }}
                >
