...
const VendorProfileViewDetails = () => {
  ...
  useEffect(() => {
    ...
    const vendorReviewsList =
      vendor.reviews?.list ?? vendor.reviews ?? vendor.reviewList ?? null;
  ...
  const fetchReviews = async (vendorId) => {
    try {
      ...
      const response = await axios.get(
        `${API_BASE}/api/vendor/${vendorId}/reviews`,
        {
    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        <View style={styles.vendorInfo}>
          <View style={styles.vendorHeader}>
            ...
            <View style={styles.ratingBadge}>
              <Image
                source={require("../assets/via-farm-img/icons/satar.png")}
              />
              <Text style={styles.vendorRating} allowFontScaling={false}>
                {String(vendorRating)}
              </Text>
            </View>
          </View>
          ...
          {vendorPhone && (
            <View style={styles.contactInfo}>
              <Image
                source={require("../assets/via-farm-img/icons/call.png")}
              />
          ...
          <Text style={styles.aboutHeader} allowFontScaling={false}>
            About
          </Text>
        ...
        <View style={styles.reviewsContainer}>
          <Text style={styles.allReviewsTitle} allowFontScaling={false}>
            All Reviews ({reviews.length} reviews)
          </Text>
          ...
          {loading ? (
            ...
            <FlatList
              ...
              keyExtractor={(item, idx) =>
                item?._id ? String(item._id) : String(idx)
              }
            ...
            <View style={styles.emptyBox}>
              ...
              <Text style={styles.noReviewText} allowFontScaling={false}>
                No reviews yet.
              </Text>
            </View>
          )}
