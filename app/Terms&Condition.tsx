    ...
    try {
      ...
      if (
        ...
        if (parsedSections && parsedSections.length) {
          ...
          setError(
            "Loaded content but could not structure into sections; showing raw content from server.",
          );
        }
      } else {
  ...
  const parseApiContent = (content) => {
    ...
    for (let i = 0; i < allLines.length; i++) {
      ...
      if (!line) {
        if (
          current &&
          current._accumParagraph &&
          current._accumParagraph.length
        ) {
  ...
  const renderContent = () => {
    ...
    return (
      <>
        {error ? (
          <View
            style={[styles.footerNote, { marginBottom: moderateScale(12) }]}
          >
            ...
            <TouchableOpacity onPress={fetchTermsAndConditions}>
              <Text
                ...
                style={{ color: "#1e40af", marginTop: moderateScale(6) }}
              >
                Retry
              </Text>
            </TouchableOpacity>
        ...
        {!sections || sections.length === 0 ? (
          <View style={styles.centerContainer}>
            ...
            <Text allowFontScaling={false} style={styles.errorMessage}>
              The server returned no content. Please try again later.
            </Text>
            <TouchableOpacity
          ...
          <>
            ...
            <View style={styles.introCard}>
              <Text allowFontScaling={false} style={styles.introTitle}>
                ViaFarm Terms & Conditions
              </Text>
              <Text allowFontScaling={false} style={styles.introSubtitle}>
                Please read these terms carefully. By using ViaFarm, you agree
                to all terms and conditions outlined below.
              </Text>
            </View>
              ...
              <View key={index} style={styles.sectionCard}>
                ...
                <View style={styles.sectionHeader}>
                  <View style={styles.sectionNumberBadge}>
                    <Text allowFontScaling={false} style={styles.sectionNumber}>
                      {section.number}
                    </Text>
                  </View>
