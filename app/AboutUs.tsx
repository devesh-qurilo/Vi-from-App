      ...
      if (blocks.length === 0) {
        ...
        if (isHeading) {
          const cleanedTitle = first
            .replace(
              /^[\u{1F300}-\u{1FAFF}\u{1F600}-\u{1F64F}\u{2700}-\u{27BF}\u{1F680}-\u{1F6FF}\u{2600}-\u{26FF}\s]+/u,
              "",
            )
            .trim();
                ...
                <View style={styles.contentSection}>
                  {Array.isArray(paragraphs) && paragraphs.length > 0 ? (
                    ...
                    <Text allowFontScaling={false} style={styles.contentText}>
                      ViaFarm connects consumers directly with local farmers and
                      small producers — delivering fresh produce with
