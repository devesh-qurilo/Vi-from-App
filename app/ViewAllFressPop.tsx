    ...
    <View style={[cardStyles.container, { width: cardWidth }]}>
      ...
      >
        ...
        <View style={cardStyles.cardContent}>
          ...
          <Text
            allowFontScaling={false}
            style={cardStyles.productSubtitle}
            numberOfLines={1}
          >
          ...
          {item?.variety ? (
            <View allowFontScaling={false} style={cardStyles.productSubtitlee}>
              <Image
                style={{
              ...
              <Text
                allowFontScaling={false}
                style={{ fontSize: normalizeFont(12), color: "grey" }}
              >
                {item.distance}
              </Text>
            </View>
          ...
          <View style={cardStyles.priceContainer}>
            ...
            {item?.weightPerPiece ? (
              <Text allowFontScaling={false} style={cardStyles.productUnitt}>
                /{item.weightPerPiece}
              </Text>
            ) : null}
          </View>
